...
public class LoadingMoreFooter extends LinearLayout {
    ...
    public void initView(){
        ...
        progressCon.setView(pbLoading);
//        AVLoadingIndicatorView progressView = new AVLoadingIndicatorView(this.getMContext());
...
//        layoutParams.setMarginStart((int)getResources().getDimension(R.dimen.textandiconmargin));
    ...
    public void setProgressStyle(int style) {
        if(style == ProgressStyle.SysProgress){
            ...
            progressCon.setView(pbLoading);
//            AVLoadingIndicatorView progressView = new  AVLoadingIndicatorView(this.getMContext());
//            progressView.setIndicatorColor(0xffe7439a);
