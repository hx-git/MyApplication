...
import com.cali.libcore.view.behavior.source.HeaderScrollingViewBehavior;
...
public class MainContentBehavior extends HeaderScrollingViewBehavior {
    ...
    private int getFinalHeight() {
        return mContext.getResources().getDimensionPixelOffset(R.dimen.title_height) + UIUtils.getStatusBarHeight(mContext);
    }
